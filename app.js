 ...
 *
 * @author Rackspace Web Team and Cameron Strandberg -- QuickMobile Inc.
 * 
 * @version 0.1
 */
document.observe("dom:loaded", function () {
    ...
    var logoRow = new Element('tr').update('<td colspan="2" id="quartzy-logo"></td><td id="search-wrap"></td>');
